...
$result= $dal_order->getUserOrderDetail($_REQUEST['orderid']); 
...
$result_user=$dal_order->getUserDataByCartId($cartId);   
if($result->num_rows){
      ...
      <div class="well col-md-12 center login-box">
         ...
         <div class="col-md-4">			
					<div class="input-group input-group-md">
                        <span class="input-group-addon"><a href=""> User Id:</a></span>
                        <input type="button" class="form-control btn-round" name="role" value="<?php echo $user_id;?>" >
        ...
        <div class="col-md-4">			
					<div class="input-group input-group-md">
                        ...
                        <input type="button" class="form-control btn-round" name="role" value="<?php echo $first_name;?>" >
        ...
        <div class="col-md-4">			
					<div class="input-group input-group-md">
                        ...
                        <input type="button" class="form-control btn-round" name="role" value="<?php echo $last_name?>" >
         ...
         <div class="col-md-4">			
					<div class="input-group input-group-md">
                        <span class="input-group-addon">Cell No:</span>
                        <input type="button" class="form-control btn-round" name="role" value="<?php echo $cell;?>" >
        ...
        <div class="col-md-4">			
					<div class="input-group input-group-md">
                        ...
                        <input type="button" class="form-control btn-round" name="role" value="<?php echo $email;?>" >
        ...
        <div class="col-md-4">			
					<div class="input-group input-group-md">
                        ...
                        <input type="button" class="form-control btn-round" name="role" value="<?php echo $gender?>" >
         ...
         <div class="col-md-12">			
					<div class="input-group input-group-md">
                        ...
                        <input type="button"  class="form-control btn-round" name="role" value="<?php echo $address?>" >
        ...
        <div class="col-md-4">			
         ...
         <div class="col-md-12">			
					<div class="input-group input-group-md">
                        ...
                        <input type="button" class="form-control btn-round" name="role" value="<?php echo $billingAddress;?>" >
...
?>    
    <tr>
        ...
        <td style="text-align:center;"><?php echo $row['product_discount'];
        $subTotal=($row['price']-($row['price']*$row['product_discount']/100))*$row['quantity'];
        $total+=$subTotal;    
        ?></td>
